...
from selenium.webdriver.common.devtools.v140.css import CSSStyle
...
#WE WILL NEED THIS TO RUN TWICE AS THE "BUTTON (GOT IT) APPEARD TWICE DURING THE INTIAL GAME STARTUP
def terms_click():
    try:
        # Find and click the terms button
        terms = driver.find_element(by=By.CSS_SELECTOR, value="body > div.cc_banner-wrapper > div > a.cc_btn.cc_btn_accept_all")
        print("Found terms button, clicking...")
        terms.click()
    except:
        print("Terms button not found")

# Handle initial popups (terms of use)
print("Looking for terms of use...")
terms_click()
...
sleep(2)
# Handle initial popups 2 (cookies consent)
print("Looking for cookies consent...")
terms_click()
...
while True:
    ...
    if time() > timeout:
        try:
            ...
            products = driver.find_elements(by=By.CLASS_NAME, value="storeSection")
